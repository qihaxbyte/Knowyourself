...
export default function Konsultasi() {
  ...
  return (
    <div className="flex h-screen w-full flex-col relative overflow-hidden" style={{
      ...
      <footer className="border-t px-4 py-3 z-10 backdrop-blur-md" style={{ borderColor: "rgba(232,224,213,0.5)", background: "rgba(255,255,255,0.65)" }}>
